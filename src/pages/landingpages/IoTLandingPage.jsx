...
import bannerVid from "../../assets/videos/iot.mp4";
...
const IoTLandingPage = () => {
  const pageTitle = "Connected IoT Ecosystems";
  const pageDescription = "Building connected systems that turn data into intelligent action and business value.";
  
  const getHeroImg = () => {
    return require("../../assets/images/iot-dev-hero.webp");
  };
        ...
        <div className="sm:max-w-[85vw] lg:!max-w-[55vw] w-full mx-auto -translate-y-[5rem] lg:-translate-y-[6rem] relative z-[5] rounded-[3rem] overflow-hidden bg-bgGrey">
          ...
          <div className="p-5 sm:p-6">
            ...
            >
              ...
              transformative IoT ecosystems that connect devices, analyze data, and enable smart automation across your organization.
              Our expertise spans from building intelligent, custom connected device networks to implementing robust AI-powered systems that automate, adapt,
              and scale.
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-[40%,1fr] gap-10">
            ...
            <div data-aos="fade-up" className="space-y-6">
              <h2 className="text1 font-bold">
                Fueling Digital Success with Connected IoT Ecosystems
              </h2>
              ...
              <p className="desc">
                ...
                to your unique goals. Whether it's connecting smart devices, analyzing IoT data streams,
        ...
        <div className="wrapper">
          <div className="text-center mb-12" data-aos="fade-up">
            ...
            <p className="desc max-w-3xl mx-auto mt-4">
              Let's discuss how our IoT development expertise can help you achieve your business goals. Fill out the form below, and our team will get back to you within 24 hours.
            </p>
          </div>
