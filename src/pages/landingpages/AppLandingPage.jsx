...
import bannerVid from "../../assets/videos/app-development.mp4";
...
const AppLandingPage = () => {
  const pageTitle = "Innovative Mobile Apps";
  const pageDescription = "Building next-gen mobile apps that deliver intuitive and seamless experiences.";
  
  const getHeroImg = () => {
    return require("../../assets/images/app-dev-hero.webp");
  };
      ...
      <section className="relative min-h-screen">
        ...
        <div className="wrapper absolute w-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[2] flex flex-col-reverse gap-5 sm:gap-10 lg:gap-7 lg:grid grid-cols-[1fr,20%] items-center">
          <div data-aos="fade-up" className="max-w-[50rem] space-y-1">
            <SubHeading
              heading="APP DEVELOPMENT SPECIALISTS"
        ...
        <div className="sm:max-w-[85vw] lg:!max-w-[55vw] w-full mx-auto -translate-y-[5rem] lg:-translate-y-[6rem] relative z-[5] rounded-[3rem] overflow-hidden bg-bgGrey">
          ...
          <div className="p-5 sm:p-6">
            ...
            >
              ...
              transformative mobile solutions that combine sleek design with high performance for an unmatched user experience.
              Our expertise spans from building intelligent, custom mobile applications to implementing robust AI-powered systems that automate, adapt,
              and scale.
            </p>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-[40%,1fr] gap-10">
            ...
            <div data-aos="fade-up" className="space-y-6">
              <h2 className="text1 font-bold">
                Fueling Digital Success with Innovative App Solutions
              </h2>
              ...
              <p className="desc">
                ...
                to your unique goals. Whether it's crafting intuitive mobile applications, optimizing user engagement,
        ...
        <div className="wrapper">
          <div className="text-center mb-12" data-aos="fade-up">
            ...
            <p className="desc max-w-3xl mx-auto mt-4">
              Let's discuss how our app development expertise can help you achieve your business goals. Fill out the form below, and our team will get back to you within 24 hours.
            </p>
          </div>
